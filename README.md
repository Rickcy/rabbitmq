...
==================
Wrapper based on php-amqplib library to incorporate messaging in your Yii2 application via RabbitMQ

This documentation is relevant for the version 2.\*, which require PHP version >=7.0
...
return [
    ...
    'components'    => [
        // ...
        'rabbitmq' => [
            'class' => \rickcy\rabbitmq\Configuration::class,
            'connections' => [
                [
...
use rickcy\rabbitmq\components\ConsumerInterface;
